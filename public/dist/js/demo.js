...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('RSUD Bagas Waras:Demo:MessageShowed')) < Date.now()) {
      localStorage.setItem('RSUD Bagas Waras:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      alert('Selamat Datang di Aplikasi Dashboard Admin RSUD Bagas Waras','<br>', 'Website ini dibuat Oleh Muhammad Syaiful Anwar')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Customize RSUD Bagas Waras</h5><hr class="mb-2"/>'
  )
